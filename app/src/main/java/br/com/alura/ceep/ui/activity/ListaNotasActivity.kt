...
class ListaNotasActivity : AppCompatActivity() {
    ...
    //Retrofit sem Coroutines
    //        val call = RetrofitInitializer.getService(NotaService::class.java).getAll()
//        lifecycleScope.launch(IO) {
//            val response = call.execute()
//            val notas = response.body()?.let {notas ->
//                notas.map{ it.nota}
//            }
//        }
//        call.enqueue(object : Callback<List<NotaResposta>> {
//            override fun onResponse(call: Call<List<NotaResposta>>, resp: Response<List<NotaResposta>>) {
//                resp.body()?.let{ notasResposta ->
//                    val notas = notasResposta.map{it.nota}
//                }
//            }
//
//            override fun onFailure(call: Call<List<NotaResposta>>, t: Throwable) {
//                Log.e("Erro","Erro na resposta",t)
//            }
//
//        })
